...
const HomePage = () => {
	return (
		<motion.div
			...
			className="w-full h-fit flex items-center justify-center flex-col relative mb-0 sm:mb-[20vw] lg:mb-0"
		>
			<motion.nav
			...
			<div className="z-10 mt-[15vw] sm:mt-[10vw] lg:mt-[7.5vw]">
				<motion.h1
					...
					className="text-[12.5vw] lg:text-[7.5vw] uppercase font-bold text-white"
				>
					Metaverse
				</motion.h1>
				<motion.div
			...
			<motion.div
				...
				className="w-full h-fit flex items-center justify-end relative"
			>
